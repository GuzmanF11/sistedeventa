    ...
    public partial class frmProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            foreach (Proveedor item in lista)
            {
                ...
                dgvdata.Rows.Add(new object[] {"",item.IdProveedor,item.Documento,item.Rubro,item.Correo,item.Telefono,
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdProveedor == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    dgvdata.Rows.Add(new object[] {"",idgenerado,txtdocumento.Text,txtrubro.Text,txtcorreo.Text,txttelefono.Text,
