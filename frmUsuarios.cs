    ...
    public partial class frmUsuarios : Form
    {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            if(idusuariogenerado != 0)
            {
                ...
                ((OpcionCombo)cborol.SelectedItem).Txto.ToString(),
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Rol"].Value = ((OpcionCombo)cborol.SelectedItem).Txto.ToString();
...

        {
         ...
         List<Rol> listaRol = new CN_Rol().Listar();
            ...
            {
                cborol.Items.Add(new OpcionCombo() { Valor = item.IdRol, Txto = item.Descripcion});
            }
            cborol.DisplayMember = "Txto";
